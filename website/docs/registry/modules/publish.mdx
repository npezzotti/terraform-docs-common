...
description: Anyone can publish and share modules on the Terraform Registry.
---
...
![Publish Module flow animation](/img/docs/registry-publish.gif)
...
The owner of a module is able to use the Terraform Registry to remove one or all versions of the module. Please be aware that [we recommend against removing anything from the Registry unless it contains a critical flaw](/registry/faq#how-do-i-remove-a-version-of-my-provider-module-or-policy-library-that-has-already-been-published).

To do this, browse to your module's page and select the appropriate option from the "Manage Module" dropdown menu.
