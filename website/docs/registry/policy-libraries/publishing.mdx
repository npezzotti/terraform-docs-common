...
The owner of a policy library is able to remove it entirely from the Terraform Registry. Please be aware that [we recommend against removing anything from the Registry unless it contains a critical flaw](/registry/faq#how-do-i-remove-a-version-of-my-provider-module-or-policy-library-that-has-already-been-published).

To do this, browse to your policy library's page and select "Delete library" from the dropdown menu.
